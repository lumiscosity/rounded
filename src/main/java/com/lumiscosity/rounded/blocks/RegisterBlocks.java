...
public class RegisterBlocks {
    ...
    public static final BlockItem TROUGH_ITEM = new BlockItem(TROUGH, new Item.Settings());
    ...
    public static final Block DEAD_BLADDERWRACK = new DeadCoralFanBlock(
                    AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_BROWN).solid().instrument(NoteBlockInstrument.BASEDRUM).requiresTool().noCollision().breakInstantly()
    );
