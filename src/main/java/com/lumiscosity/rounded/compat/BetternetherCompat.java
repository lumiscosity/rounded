package com.lumiscosity.rounded.compat;
            ...
            public class BetternetherCompat {
                public static final Block TREATED_ANCHOR_TREE_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "anchor_tree_planks")))
                );
                ...
                public static final Block TREATED_MUSHROOM_FIR_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "mushroom_fir_planks")))
                );
                ...
                public static final Block TREATED_NETHER_MUSHROOM_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "nether_mushroom_planks")))
                );
                ...
                public static final Block TREATED_NETHER_REED_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "nether_reed_planks")))
                );
                ...
                public static final Block TREATED_NETHER_SAKURA_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "nether_sakura_planks")))
                );
                ...
                public static final Block TREATED_RUBEUS_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "rubeus_planks")))
                );
                ...
                public static final Block TREATED_STALAGNATE_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "stalagnate_planks")))
                );
                public static final Item TREATED_STALAGNATE_PLANKS_ITEM = new BlockItem(TREATED_STALAGNATE_PLANKS, new Item.Settings());
            
            
                public static final Block TREATED_WART_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "wart_planks")))
                );
                public static final Item TREATED_WART_PLANKS_ITEM = new BlockItem(TREATED_WART_PLANKS, new Item.Settings());
            
            
                public static final Block TREATED_WILLOW_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("betternether", "willow_planks")))
                );
        ...
        register_treated_plank("compat/betternether/treated_wart_planks", TREATED_WART_PLANKS, TREATED_WART_PLANKS_ITEM, "betternether", "wart");
        register_treated_plank("compat/betternether/treated_willow_planks", TREATED_WILLOW_PLANKS, TREATED_WILLOW_PLANKS_ITEM, "betternether", "willow");
