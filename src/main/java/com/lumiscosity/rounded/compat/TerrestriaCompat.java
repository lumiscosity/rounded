package com.lumiscosity.rounded.compat;
            ...
            public class TerrestriaCompat {
                ...
                public static final Block TREATED_YUCCA_PALM_PLANKS = new Block(
                    Block.Settings.copy(Registries.BLOCK.get(Identifier.of("minecraft", "oak_planks")))
                );
                public static final Item TREATED_YUCCA_PALM_PLANKS_ITEM = new BlockItem(TREATED_YUCCA_PALM_PLANKS, new Item.Settings());
        ...
        register_treated_plank("compat/terrestria/treated_yucca_palm_planks", TREATED_YUCCA_PALM_PLANKS, TREATED_YUCCA_PALM_PLANKS_ITEM, "terrestria", "yucca_palm");
